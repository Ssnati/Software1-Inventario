...
public class AddProduct extends JDialog {
    ...
    public void initComponents(ActionListener listener) {
        ...
        lblSuperior.setBorder(BorderFactory.createEmptyBorder(20, 20, 0, 20));
        ...
        AddProd_txt_cant.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent e) {
                ...
                if (Character.isLetter(validar)) {
                    e.consume();
                    lblAviso.setText("<html><center>Debe ingresar números enteros positivos que no superen " + Integer.MAX_VALUE + ".</html></center>");
                }
            }
        });
        ...
        AddProd_txt_Price.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent e) {
                ...
                if (Character.isLetter(validar)) {
                    e.consume();
                    lblAviso.setText("<html><center>Solo se deben ingresar valores numericos positivos.<br/>Para colocar valores decimales se debe poner (.)</html></center>");
                }
            }
        });
...
//		panelCentral.add(lblNewLabelAviso2, "cell 1 3 3 1,alignx center");
    ...
    public void resetWindow() {
        AddProd_txt_cant.setText("");
        AddProd_txt_Price.setText("");
        lblAviso.setText("");
    }
}
